...
def parse_args():
    ...
    parser.add_argument('--dataset_name', type=str, help="dataset name", default="uganda", choices=["uganda"])
    parser.add_argument('--data_folder', type=str, default="/data6/wuyinjun/image_causal_data/uganda/", help="std of the initial phi table")
    ...
    parser.add_argument('--featurization', type=str, choices=[one, two, three], default=one)
    ...
    parser.add_argument('--method', type=str, default="dragonnet", help="std of the initial phi table")
    ...
    parser.add_argument("--backbone", type=str, default=None, help="std of the initial phi table")
