...
#	                mkdir -p ${out_folder}
			...
			cmd="python train_tabular.py --epochs 2000 --num_treatments 3 --dataset_name tcga --batch_size 32 --lr 1e-4 --topk_act 10 --program_max_len 100 --model_config configs/configs_tcga.yaml --data_folder ${data_root_folder}  --method ${method} --seed ${seed}  --log_folder $out_folder"
