...
do
	...
	do
		...
		do
			...
			init_cmd="python train_tabular.py --epochs 200 --num_treatments 2 --dataset_name ihdp --batch_size 32 --lr 1e-3 --topk_act 1 --program_max_len 6 --model_config configs/configs_ihdp.yaml --data_folder /data2/wuyinjun/causal_tabular/ --test_noise_mag ${ratio}  --method ${method} --seed ${seed}  --dataset_id"
