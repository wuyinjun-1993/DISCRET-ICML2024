...
#out_root_folder="/data2/wuyinjun/causal_tabular/tcga/"
#>>>>>>> 9385e976c9430f0b26f74daa7cdee8b301209cb9
...
#	                mkdir -p ${out_folder}
			...
			cmd="python train_tabular.py --epochs 2000 --num_treatments 3 --dataset_name tcga --batch_size 32 --lr 1e-4 --topk_act 1 --program_max_len 6 --model_config configs/configs_tcga.yaml --data_folder /data2/wuyinjun/causal_tabular/  --method ${method} --seed ${seed}  --log_folder $out_folder"
			#cmd="python train_tabular.py --epochs 2000 --num_treatments 2 --dataset_name tcga --batch_size 32 --lr 1e-4 --topk_act 1 --program_max_len 6 --model_config configs/configs_tcga.yaml --data_folder /data5/data6/wuyinjun/causal_tabular/  --method ${method} --seed ${seed}  --log_folder $out_folder"
