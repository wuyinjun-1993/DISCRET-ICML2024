...
out_root_folder="/data2/wuyinjun/causal_tabular/news_cont/"
...
#	                mkdir -p ${out_folder}
			...
			init_cmd="python train_tabular.py --epochs 2000 --num_treatments 2 --dataset_name news_cont --batch_size 32 --lr 1e-3 --topk_act 1 --program_max_len 6 --model_config configs/configs_news_cont.yaml --data_folder /data2/wuyinjun/causal_tabular/  --method ${method} --seed ${seed}  --dataset_id"
			cmd="bash run_news_2.sh "${init_cmd}" "$out_folder" "${gpu_id}
