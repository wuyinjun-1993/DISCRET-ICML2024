...
out_root_folder="/data2/wuyinjun/causal_tabular/ihdp/"
...
#	                mkdir -p ${out_folder}
			...
			init_cmd="python train_image.py --lr 1e-3 --topk_act 1 --program_max_len 4 --dataset_name uganda --model_config configs/configs.yaml --method TransTEE --log_folder /data6/wuyinjun/image_causal_data/uganda/TransTEE/logs//1 --seed ${seed} --dataset_id "
			
			# --epochs 2000 --num_treatments 2 --dataset_name ihdp --batch_size 32 --lr 1e-4 --topk_act 1 --program_max_len 6 --model_config configs/configs_ihdp.yaml --data_folder /data2/wuyinjun/causal_tabular/  --method ${method} --seed ${seed}  --dataset_id"
