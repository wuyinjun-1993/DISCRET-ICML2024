...
#	                mkdir -p ${out_folder}
			...
			init_cmd="python train_tabular.py --epochs 2000 --num_treatments 2 --dataset_name ihdp_cont --batch_size 32 --lr 1e-3 --topk_act 100 --program_max_len 100 --model_config configs/configs_cont.yaml --data_folder /data3/wuyinjun/causal_tabular/  --method ${method} --seed ${seed}  --dataset_id"
