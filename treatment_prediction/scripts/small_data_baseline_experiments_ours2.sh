...
do
	...
	do
		...
		do
			...
			init_cmd="python train_tabular_rl.py --gpu_db  --epochs 2000 --num_treatments 2 --dataset_name ihdp --batch_size 32 --lr 1e-3 --topk_act 1 --program_max_len 4 --model_config configs/configs_ihdp.yaml --data_folder /data2/wuyinjun/causal_tabular/ --subset_num ${ratio}  --method ${method} --seed $seed --backbone TransTEE  --dataset_id"
