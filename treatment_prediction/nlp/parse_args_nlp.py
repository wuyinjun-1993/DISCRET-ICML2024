...
def parse_args():
    ...
    parser.add_argument('--dataset_name', type=str, help="dataset name", default="music", choices=["music", "EEEC"])
    parser.add_argument('--data_folder', type=str, default="/data6/wuyinjun/nlp_causal_data/", help="std of the initial phi table")
